...
function resumo (resp, aluno, unidade, hora) {
...
function execute (user, msg) {
    ...
    var horario = banco.db[user].dados['horario'];
    ...
    if (modoOP == false) {
        if (stage == 1) {
            ...
            if (modoED == true) {
                ...
                return [[resumo(nomeResponsavel, nomeAluno, nomeUnidade, horario), confirmacao], ['msg', 'msg']];
            }
        ...
        if (stage == 3) {
            ...
            if (modoED == false) {
                var msg3 = 'Por fim, informe o horário⌚:\n(```Aconselhamos ver o horário de funcionamento no tópico *Unidades*📍```)';
        ...
        if (stage == 4) {
            banco.db[user].dados['horario'] = msg;
            horario = msg;
